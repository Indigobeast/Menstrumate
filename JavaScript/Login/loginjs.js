...
function submitHandler4(event) {
  ...
  dataObj.month_days = monthDays;
  dataObj.week_days = weekDays;
...
document
  ...
  .addEventListener("click", submitHandler1);
document
  .getElementById("submitbutton2")
  .addEventListener("click", submitHandler2);
document
  .getElementById("submitbutton3")
  .addEventListener("click", submitHandler3);
document
  .getElementById("submitbutton4")
  .addEventListener("click", submitHandler4);
document
  .getElementById("submitbutton5")
  .addEventListener("click", submitHandler5);
